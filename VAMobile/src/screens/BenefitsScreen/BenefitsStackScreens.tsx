...
import PlaceCall from "./ClaimsScreen/ClaimDetailsScreen/ClaimStatus/WhatDoIDoIfDisagreement/PlaceCall";
...
export const getBenefitsScreens = (): Array<ReactNode> => {
  return [
    ...
    <BenefitsStack.Screen key={'PlaceCall'} name="PlaceCall" component={PlaceCall} options={LARGE_PANEL_OPTIONS} />,
